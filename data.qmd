...
The data is collected and distributed by the U.S. Energy Information Administration.
...
1.  Energy Review Category: "Primary energy overview", "Primary energy production by source", "Primary energy consumption by source"
2.  Renewable Energy Category: "Production and consumption by source"
3.  Environment Category: "By source"
...
1.  **Unveiling Energy Trends:**
    ...
    Data Source: Utilize "Primary energy production by source" and "Primary energy consumption by source" from the dataset.
...
3.  **Price Dynamics and Supply-Demand:**
    ...
    Data Source: Utilize "Energy Prices" and "Primary energy overview" from the dataset.
...
4.  **Renewable Energy's impact on Conventional Sources**
    ...
    Data Source: Utilize "Production and consumption by source" of "Renewable Energy", "Primary energy production by source" and "Primary energy consumption by source" from the dataset.
...
5.  **Carbon Emissions and Energy Mix:**
    ...
    Data Source: Utilize Carbon dioxide emissions by source" of "Environment".
...
library(ggplot2)
library(forcats)
renewable <- read.csv("C:/Users/admin/Desktop/renewable.csv")
```
