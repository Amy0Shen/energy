...
2.  Renewable Energy Category: "Table_10.1_Renewable_Energy_Production_and_Consumption_by_Source" (608 rows each for one month, 14 columns with one column of months and 13 columns of renewable energy production and consumption data)
3.  Environment Category: "Table_11.1_Carbon_Dioxide_Emissions_From_Energy_Consumption_by_Source" (608 rows each for one month, 15 columns with one column of months and 14 columns of $CO_2$ emission data by different energy source)
